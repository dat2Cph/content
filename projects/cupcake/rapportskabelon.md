...
Navigationsdiagrammer laves som UML Tilstandsmaskiner [state machine diagram]([webstack/backend/statemachinediagram.md](https://github.com/dat2Cph/content/edit/main/webstack/backend/statemachinediagram.md)). Bemærk specielt at det, der hedder “composite state”, er meget velegnet til at indkapsle at man er logget ind.
